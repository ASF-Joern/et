...
{block name="frontend_detail_swag_custom_products_default_option_wrapper"}
    {if $swagCustomProductsTemplate}
        ...
        <div class="{$breadcrumbName|replace:" ":""}-detail custom-products--data-wrapper panel has--border">

            {* Form needs a id cause we have inputfields not directly in the form *}
            <form class="custom-products--form" id="swagArticleForm"
