                        ...
                        <div class="buybox-top">
                                <div class="product--delivery" style="display:block;">
                                    ...
                                    <p class="delivery--information" style="display:block;">
                                        <span class="delivery--text delivery--text-more-is-coming">
                                            ...
                                            {s name="DetailDataShippingtime"}{/s} {$sBasketItem.shippingtime} {s name="DetailDataShippingDays"}{/s}
                                        </span>
                                    </p>
                                </div>
                            </nav>
                            ...
                            <ul class="product--base-info list--unstyled">
                                <li class="base-info--entry entry--sku">
                                    ...
                                    <meta itemprop="productID" content="{$sBasketItem.articleDetailsID}"/>
                                    <span class="entry--content" itemprop="sku">{$sBasketItem.ordernumber}</span>
                                </li>
                            </ul>
                        </div>
                    {/block}
