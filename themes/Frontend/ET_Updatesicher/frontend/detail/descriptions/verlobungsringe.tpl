...
<div class="product--properties desc_box_table">
	...
	<td id="table_width" class="product--properties-value">{$sArticle.width|replace:".":","}mm
		<div class="tooltip">[?] 
			...
			Der Wert bezieht sich auf die breiteste Stelle des Verlobungsrings.
			</div>
			</div>
		</div>
	</td>
	...
	<td id="table_weight" class="product--properties-value">ca. {$sArticle.weight|replace:".":","}g</td>
	</tr>
	<tr class="product--properties-row">
...
<div class="product--properties desc_box_table">
	...
	<tbody>
	<tr class="product--properties-row">
	<td class="product--properties-label is--bold">Gewicht/Ma&szlig;e:</td>
	<td id="table_stone" class="product--properties-value">{$stone.1}</td>
	</tr>
	<tr class="product--properties-row">
	<td class="product--properties-label is--bold">Anzahl:</td>
	<td class="product--properties-value">{$sArticle.attr11}</td>
	</tr>
	<tr class="product--properties-row">
	<td class="product--properties-label is--bold">Steinart/Form:</td>
	<td class="product--properties-value">{$sArticle.attr14}</td>
	</tr>
	<tr class="product--properties-row">
...
<h3>Verlobungsringe Anfertigung</h3>
<p>Bitte beachten Sie, dass alle Verlobungsringe individuell f&uuml;r Sie angefertigt werden.</p>
</div>
        ...
        <div class="desc_box_vorteile">
            ...
            <div class="zertifikat-box" style="height: 180px;">
                ...
                <table class="mf zertifikat-table" style="width: 70%; float: left; line-height: 16px;">
                    ...
                    <tr class="row-right">
						{assign var="refinement" value=" / "|explode:$sArticle.attr14}
                        <td class="white" style="background: white; float: left; border-right: 1px solid #efefef; margin-right: 5px; padding-right: 5px;"><span>Steinart: <span id="zertStone">{$refinement.0}</span></span></td>
                        <td class="white" style="background: white; float: left;"><span>Schliff: <span id="zertRefinement">{$refinement.1}</span></span></td>
                    </tr>
                    <tr class="row-right">
