...
{block name="frontend_listing_filter_facet_range"}
    <div class="{$asfDesignClass}filter-panel filter--range facet--{$facet->getFacetName()|escape:'htmlall'}"
        ...
        {block name="frontend_listing_filter_facet_range_flyout"}
            <div class="{$asfDesignClass} filter-panel--flyout">
                ...
                {block name="frontend_listing_filter_facet_range_title"}
                    <label class="{$asfDesignClass}filter-panel--title">
                ...
                {block name="frontend_listing_filter_facet_range_content"}
                    <div class="{$asfDesignClass}filter-panel--content">
