...
{block name="content/main"}
    <form action="{url controller=AsfRingManager action=saveAndUpdateMemoirenringe}" method="post">
                                        ...
                                        <div class="input-group">
                                            <ul class="list-inline">
                                                ...
                                                {foreach from=$profiles item=profile}
                                                    {if $profile.number == "3" || $profile.number == "4"}
                                            ...
                                            <div class="input-group">
                                                <ul class="list-inline">
                                                    ...
                                                    {foreach from=$entries key=subkey item=entry}
                                                        {if $entry@iteration >= 3 && $entry@iteration <= 4}
